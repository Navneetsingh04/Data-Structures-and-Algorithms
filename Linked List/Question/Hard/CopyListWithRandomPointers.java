/*
L.C: 138. Copy List with Random Pointer
...
public class CopyListWithRandomPointers {
    ...
    // Connect random pointers of the copy nodes
    ...
    public static void main(String args[]){
        ...
        // Printing the copied list to verify
        Node temp = copiedList;
        while (temp != null) {
            System.out.print("Node val: " + temp.data + ", Random val: " + (temp.random != null ? temp. random.data : "null") + "\n");
            temp = temp.next;
        }
    }
}