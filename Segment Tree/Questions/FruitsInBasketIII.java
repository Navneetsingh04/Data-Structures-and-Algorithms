/*
L.C: 3479. Fruits Into Baskets III
...
public class FruitsInBasketIII {
    private static void buildTree(int i,int l,int r,int baskets[],int segmentTree[]){
        if(l == r){
    ...
    private static boolean querySegmentTree(int i ,int l,int r,int segmentTree[],int fruit){
